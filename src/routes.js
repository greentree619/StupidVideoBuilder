...
const routes = [
  ...
  { path: '/theme/article', name: 'Video Theme Upload', element: ArticleThemeUpload },
  ...
  { path: '/article/list', name: 'All Videos', element: AllArticles },
  { path: '/article/view', name: 'Video View', element: ArticleView },
  { path: '/article/add', name: 'Create New Video', element: NewArticle },
  { path: '/article/approval', name: 'Approval Video', element: ApprovalArticle },
